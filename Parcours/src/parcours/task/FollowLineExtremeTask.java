...
public class FollowLineExtremeTask extends ControllerTask {
	...
	private static final int LOST_LINE_MAX = 175; // 100 works; 500 clearly to
													// large
	...
	private boolean handleLostLine(int error) {
		...
		if (foundLine) {
			...
			if (angle < SMALL_ANGLE) {
				...
				errorDerivated = 0;
				Sound.playTone(50 * angle, 200);
				RobotDesign.differentialPilot.rotate(angle - 10);
			}
		} else {
